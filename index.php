    ...
    <section class="container header d-none d-md-block">
        <ul class="row list-unstyled m-0 p-0">
            ...
            <ul class="list-inline pl-0 text-left menu">
              <li class="list-inline-item mr-4">
                ...
                <ul class="list-unstyled submenu">
                  ...
                  <li><a href="#">Одежда для дома и сна</a></li>
                  <li><a href="#">Майки и футболки</a></li>
                  <li><a href="#">Купальники</a></li>
                  <li><a href="#">Носки и колготки</a></li>
                  <li><a href="#">Корректирующее бельё</a></li>
              ...
              <li class="list-inline-item mr-4">
                ...
                <ul class="list-unstyled submenu">
                  ...
                  <li><a href="#">Одежда для дома и сна</a></li>
                  <li><a href="#">Майки и футболки</a></li>
                  <li><a href="#">Купальный ассортимент</a></li>
                  <li><a href="#">Термобельё</a></li>
          ...
          <li class="col-12 col-md-4 pr-0 d-flex align-items-center justify-content-end">
            ...
            <i class="fa fa-fw f-lg fa-search mr-3"></i>
            <i class="fa fa-fw f-lg fa-shopping-bag"></i>
          </li>
        </ul>
    </section>
                        ...
                        <div class="carousel-item active">
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-12">
                                    <a href="#"><img src="img/newcol.png" alt=""/></a>
                                </div>
                                <div class="col-md-6 col-sm-6 col-12">
                                    <a href="#"><img src="img/newcol.png" alt=""/></a>
                                </div>
        ...
        <div class="row px-5">
          <div class="col-md-6 col-12">
            ...
            <div class="carousel-caption infoblock1">
              <h3 class="mb-1">Название товара</h3>
              <p class="usl">условие акции</p>
              <p class="sale-price">1199 р</p>
              <a class="sale-buy" href="#">Купить</a>
            </div>
          </div>
          <div class="col-md-6 col-12">
...
<section class="container mb-5 novinki">
  <h2 class="mb-4">Новинки</h2>
  <div id="carousel-n" class="carousel slide" data-ride="false">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <div class="row px-5">
        <div class="col-md-3 col-12">
          <img class="img-fluid" src="img/nov1.png" alt="...">
          <div class="carousel-caption infoblock2">
            <h4 class="mt-0 my-2">Пижама Forest Berry</h4>
            <ul class="list-unstyled sku-params">
              <li>цвет</li>
              <li>размер</li>
            </ul>
            <p class="sku-price">1199 ₽</p>
          </div>
        </div>
        <div class="col-md-3 col-12">
          <img class="img-fluid" src="img/nov2.png" alt="...">
          <div class="carousel-caption infoblock2">
            <h4 class="mt-0 my-2">Пижама Forest Berry</h4>
            <ul class="list-unstyled sku-params">
              <li>цвет</li>
        ...
        <div class="col-md-3 col-12">
          <img class="img-fluid" src="img/nov3.png" alt="...">
          <div class="carousel-caption infoblock2">
            <h4 class="mt-0 my-2">Пижама Forest Berry</h4>
            <ul class="list-unstyled sku-params">
              <li>цвет</li>
        ...
        <div class="col-md-3 col-12">
          <img class="img-fluid" src="img/nov4.png" alt="...">
          <div class="carousel-caption infoblock2">
            <h4 class="mt-0 my-2">Пижама Forest Berry</h4>
            <ul class="list-unstyled sku-params">
              <li>цвет</li>
  ...
  <a class="carousel-control-next" href="#carousel-n" role="button" data-slide="next">
    ...
    <section class="container brands mb-5">
    <ul class="row list-unstyled">
      <li class="col-md-3"><img class="img-fluid" src="img/brandmask.png" alt=""></li>
      <li class="col-md-3"><img class="img-fluid" src="img/brandmask.png" alt=""></li>
      <li class="col-md-3"><img class="img-fluid" src="img/brandmask.png" alt=""></li>
      <li class="col-md-3"><img class="img-fluid" src="img/brandmask.png" alt=""></li>
    </ul>
